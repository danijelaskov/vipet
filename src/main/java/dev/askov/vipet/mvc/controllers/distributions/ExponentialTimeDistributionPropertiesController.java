...
public final class ExponentialTimeDistributionPropertiesController
    extends AbstractController<ExponentialTimeDistributionModel> {

  private static final Logger LOGGER =
      LoggerFactory.getLogger(ExponentialTimeDistributionPropertiesController.class);
  ...
  public ExponentialTimeDistributionPropertiesController(
      final ExponentialTimeDistributionModel model) {
    super(model);
  }
